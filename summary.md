...
- **Списки** упрорядочены и могут содержать лубликаты.
...
Теперь, зная основы множеств, давайте перейдем к рассмотрению операйий, которые доступны для этих структур данных.
